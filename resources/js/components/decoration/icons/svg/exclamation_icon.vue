<template>
  <svg
    ...
    width="122.879px"
    height="97.311px"
    viewBox="0 0 122.879 97.311"
    enable-background="new 0 0 122.879 97.311"
    xml:space="preserve"
  >
    <g>
      <path
...
@Options({ name: "ExclamationErrorIcon" })
export default class ExclamationErrorIcon extends Vue {}
</script>
